<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Success.aspx.cs" Inherits="WinningLifeInternational.Terms" %>
		...
		<section class="beautypress-inner-welocme-section beautypress-bg" style="background-image: url(img/inner-section-bg.jpg);">
			...
			<div class="container">
				<div class="beautypress-inner-welcome-content">
					...
					<h1 class="color-white">Congratulations!</h1>
					<p class="color-white">We have successfully received your message.</p>
				</div>
